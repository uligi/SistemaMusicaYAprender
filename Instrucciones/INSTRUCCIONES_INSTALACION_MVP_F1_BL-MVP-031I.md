...
Extrae `BL-MVP-031I_Paquete_Correctivo.zip` directamente sobre la raíz.

Ejecuta:

```powershell
powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\apply-bl-mvp-031i.ps1
```
...
OK: E2E BL-MVP-031 ejecutado contra el build frontend actualizado.
OK: git diff --check aprobado.
OK: BL-MVP-031I aplicado y validado.
```
