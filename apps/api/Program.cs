...
builder.Services.AddSingleton<EditorialReviewWorkflowService>();
builder.Services.AddSingleton<EditorialPublicationLifecycleService>();
...
builder.Services.AddSingleton<PersonalUsernameService>();
...
app.MapEditorialReviewWorkflow();
app.MapEditorialPublicationLifecycle();
app.MapStudySessions();
app.MapStudyExerciseFlow();
app.MapStudyExerciseEvaluation();
app.MapStudyLearningEvidence();
